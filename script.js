// import axios from "axios"; Nao deu certo esse import. A solucao que eu encontrei foi deixar um link la no index.html

const containerVideos = document.querySelector(".videos__container");

async function buscarEMostrarVideos() {
  const isProd = window.location.hostname !== "localhost"; // Define se está em produção
  const urlVideos = isProd
